...
from text.models import Cases, SRQs, TMPSRQ
...
if temp_count > 3000:
    ...
    print("\nI know there are more than 3000 items.\nCurrently for test purpose, remember to recover this to less than 3000.")
    ...
    r = requests.get('http://10.55.52.211:45471', json=json_sent)
    ...
    r = requests.get('http://10.55.52.211:45471', json={'json':cases_json, 'mode':'Pred'})
