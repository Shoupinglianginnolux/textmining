...
from .models  import OSR, ComboPartsList
...
list_of_files = glob.glob(local_file_D_dir +'*.xlsx')
latest_file = max(list_of_files, key=os.path.getctime)
file_name = os.path.basename(latest_file)
print('sending '+ latest_file + ' back....')
